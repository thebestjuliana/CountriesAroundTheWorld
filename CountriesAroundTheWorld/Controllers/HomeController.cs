...
namespace CountriesAroundTheWorld.Controllers
{
    public class HomeController : Controller
    {
        ...
        {
            Country a = new Country("Algeria", new List<string>() { "Arabic", "Berber" }, "Salam", "Algeria is a country located in Northern Africa bordering the Mediterranean Sea. It is considered the gateway between Africa and Europe. Neighboring countries include Libya, Mali, Mauritania, Morocco, Niger, Tunisia, and Western Sahara. Algeria is mostly desert with a few mountains and a narrow coastal plain.", new List<string>() { "green", "white", "red" });
            Countries.Add(a);
            Country b = new Country("Bahamas", new List<string>() { "English" }, "What da wybe is? ", "The Bahamas stretches for 760 miles from the coast of Florida in the northwest to almost Haiti in the southeast. The archipelago consists of about 2,400 Cays (coral reefs) and 700 islands, 30 of which are inhabited.", new List<string>() { "aquamarine", "yellow", "black" });
            Countries.Add(b);
            Country c = new Country("Bangladesh", new List<string>() { "Bengali" }, "Assalam Waleykum' ('peace be with you')", "Bangladesh is a country in Southern Asia and is located on the Bay of Bengal bordered by India on all sides except for a small border with Burma. Bangladesh has flat plains, and most of the country is situated on deltas of large rivers flowing from the Himalayas.", new List<string>() { "red", "green", "gold" });
            Countries.Add(c);
            Country d = new Country("Venezuela", new List<string>() { "Spanish" }, "Buenos Días", "Venezuela is a federal presidential republic consisting of 23 states, the Capital District and federal dependencies covering Venezuela's offshore islands. Venezuela is among the most urbanized countries in Latin America; the vast majority of Venezuelans live in the cities of the north and in the capital.", new List<string>() { "yellow", "blue", "red" });
            Countries.Add(d);
